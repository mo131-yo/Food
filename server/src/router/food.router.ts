...
foodRouter.post("/create-food-item", authentication, authorization([UserRole.ADMIN]), createFoodItem);

foodRouter.delete("/delete-food/:foodId",authentication, authorization([UserRole.ADMIN]), deleteFood)
foodRouter.patch("/update-food/:foodId", authentication, authorization([UserRole.ADMIN]), updateFood)
